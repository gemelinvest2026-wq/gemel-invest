...
Object.assign(Wizard, {
  phoenixForms: {
    health: { key:'health', path:'./בריאות+מחלות קשות.pdf', title:'הפניקס · בריאות / מחלות קשות', description:'הטופס המקורי של הפניקס לביטוח בריאות. אם קיימת בעסקה פוליסת בריאות — זהו טופס האם שממנו יתר ההצעות יורשות נתונים.', questionnairePath:'./שאלונים הפניקס.pdf' },
    ci: { key:'ci', path:'./מחק-מחס.pdf', title:'הפניקס · מחלות קשות', description:'הטופס המקורי של הפניקס למחלות קשות / מרפא סרטן.', questionnairePath:'./שאלונים הפניקס.pdf' },
    risk_short: { key:'risk_short', path:'./חיים מקוצר - עד 2 מיליון - עד גיל 55.pdf', title:'הפניקס · ריסק מקוצר', description:'נפתח כאשר אין בריאות, והמוצר הוא ריסק עד 2 מיליון ועד גיל 55.', questionnairePath:'./שאלונים הפניקס.pdf' },
    risk_long: { key:'risk_long', path:'./חיים מורחב מעל 2 מיליון - מעל גיל 55.pdf', title:'הפניקס · ריסק מורחב', description:'נפתח כאשר אין בריאות, והמוצר הוא ריסק מעל 2 מיליון או גיל מעל 55.', questionnairePath:'./שאלונים הפניקס.pdf' },
    mortgage_short: { key:'mortgage_short', path:'./משכנתא עד 2 מיליון.pdf', title:'הפניקס · משכנתא עד 2 מיליון', description:'הטופס המקורי של הפניקס למשכנתא עד 2 מיליון. קובץ זה אינו כולל שדות AcroForm, לכן בשלב זה הוא מוצג כמקור המקורי ללא ירושה דיגיטלית מלאה.', questionnairePath:'./שאלונים הפניקס.pdf' },
    mortgage_long: { key:'mortgage_long', path:'./משכנתא מעל 2 מיליון.pdf', title:'הפניקס · משכנתא מעל 2 מיליון', description:'הטופס המקורי של הפניקס למשכנתא מעל 2 מיליון. קובץ זה אינו כולל שדות AcroForm, לכן בשלב זה הוא מוצג כמקור המקורי ללא ירושה דיגיטלית מלאה.', questionnairePath:'./שאלונים הפניקס.pdf' }
  },
  ...
  async createFilledPhoenixPdf(formDef, questionnaireMode=false){
    ...
    const bytes = await fetch(sourcePath).then(r => r.arrayBuffer());
  ...
  async openPhoenixPdf(questionnaireMode=false){
    ...
    try{
      ...
      this.setHint('טעינת טופס הפניקס נכשלה. ודא שקבצי ה-PDF נמצאים לצד index.html.');
    }
  },
