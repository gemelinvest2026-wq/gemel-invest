...
$$('.navItem').forEach(b => b.addEventListener('click', (e) => {
  ...
  function render(){
    ...
    // KPI area: default visible; specific routes may hide it
    ...
    if(route === 'customers'){
      ...
      // Removed: top KPI cubes are not needed on Customers view
      if(kpisEl){ kpisEl.innerHTML = ''; kpisEl.style.display = 'none'; }
      tab = 'table';
