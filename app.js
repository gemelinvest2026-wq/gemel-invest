...
(() => {
  ...
  const BUILD = "20260328-elementary-vehicle-progress-v3";
        ...
        <div class="lcElementaryRoad">
          ...
          <div class="lcElementaryRoad__car" aria-hidden="true">
            <div class="lcElementaryRoad__carMotion">
              <svg viewBox="0 0 132 56" xmlns="http://www.w3.org/2000/svg" role="presentation">
                <defs>
                  <linearGradient id="lcCarBodyGrad" x1="14" y1="10" x2="108" y2="46" gradientUnits="userSpaceOnUse">
                    <stop stop-color="rgba(255,255,255,.96)" />
                    <stop offset="0.42" stop-color="#8cb2f3" />
                    <stop offset="1" stop-color="#3f73d8" />
                  </linearGradient>
                  <linearGradient id="lcCarGlassGrad" x1="42" y1="12" x2="78" y2="30" gradientUnits="userSpaceOnUse">
                    <stop stop-color="rgba(255,255,255,.95)" />
                    <stop offset="1" stop-color="rgba(203,227,255,.78)" />
                  </linearGradient>
                </defs>
                <ellipse class="lcElementaryRoad__carShadowSvg" cx="66" cy="47.5" rx="34" ry="5.6" />
                <path class="lcElementaryRoad__carBody" d="M20 36.5h80.3c4.4 0 8-3.5 8-7.9 0-1.8-.6-3.5-1.7-4.9l-8.2-10.3c-2.6-3.3-6.6-5.2-10.8-5.2H54.8c-4.8 0-9.3 2.3-12 6.1L35.2 25c-1.2 1.6-3 2.6-5 2.9l-8.5 1.1c-3.4.4-6 3.3-6 6.8 0 .9.7 1.7 1.7 1.7H20Z" />
                <path class="lcElementaryRoad__carBodyHighlight" d="M49.5 12.8h37.1c3.1 0 6.1 1.4 8 3.8l4.7 5.8c1 1.2.1 3-1.4 3H39.2c-1.4 0-2.2-1.6-1.3-2.7l4.8-6.1c1.7-2.4 4.5-3.8 6.8-3.8Z"/>
                <path class="lcElementaryRoad__carWindow" d="M48.7 14.6h19.1c1.2 0 2.4.5 3.2 1.4l3.7 4.1c.8.8.2 2.2-.9 2.2H42.6c-1.1 0-1.7-1.2-1-2.1l3.2-4.2c1-1 2.4-1.4 3.9-1.4Z"/>
                <path class="lcElementaryRoad__carWindow" d="M74.6 14.6h10.7c1 0 2 .4 2.7 1l5.4 4.4c1.1.9.4 2.3-1 2.3H76.5c-.9 0-1.7-.8-1.7-1.7v-4.3c0-.9.8-1.7 1.7-1.7Z"/>
                <circle class="lcElementaryRoad__carWheelOuter" cx="42" cy="37.5" r="10.5" />
                <circle class="lcElementaryRoad__carWheelOuter" cx="89" cy="37.5" r="10.5" />
                <g class="lcElementaryRoad__carWheelSpin">
                  <circle class="lcElementaryRoad__carWheelInner" cx="42" cy="37.5" r="5.2" />
                  <path class="lcElementaryRoad__carWheelSpoke" d="M42 29.8v15.4M34.3 37.5h15.4M36.6 32.1l10.8 10.8M47.4 32.1 36.6 42.9" />
                </g>
                <g class="lcElementaryRoad__carWheelSpin lcElementaryRoad__carWheelSpin--rear">
                  <circle class="lcElementaryRoad__carWheelInner" cx="89" cy="37.5" r="5.2" />
                  <path class="lcElementaryRoad__carWheelSpoke" d="M89 29.8v15.4M81.3 37.5h15.4M83.6 32.1l10.8 10.8M94.4 32.1 83.6 42.9" />
                </g>
                <path class="lcElementaryRoad__carAccent" d="M108.8 30.8h6.4" />
                <path class="lcElementaryRoad__carAccent" d="M14.8 30.8h6.1" />
              </svg>
            </div>
          </div>
