...
// ---------- Step 6 ----------
    ...
    getHealthSchema(){
      const all = ["כלל","הפניקס","הראל","מנורה","מגדל","איילון","הכשרה"];
      return [
        {
          key:"general",
          ...
          companies: all,
          questions:[
            { key:"general_chronic", text:"האם קיימת מחלה כרונית, מצב רפואי מתמשך או מעקב רפואי קבוע?", companies:all, fields:[
            ...
            { key:"general_meds", text:"האם קיימות תרופות קבועות או טיפול קבוע?", companies:all, fields:[
            ...
            { key:"general_pending", text:"האם קיימת בדיקה, בירור רפואי, ניתוח או טיפול שהומלץ ועדיין לא בוצע?", companies:all, fields:[
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"heart_main", text:"האם קיימת מחלת לב, יתר לחץ דם, הפרעת קצב או בעיה בכלי דם?", companies:all, fields:[
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"resp_main", text:"האם קיימת בעיה בריאות, בדרכי הנשימה, אסתמה, COPD או דום נשימה?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"neuro_main", text:"האם קיימת מחלה נוירולוגית, אפילפסיה, שבץ, התעלפויות או בעיה במערכת העצבים?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"mental_main", text:"האם קיימת בעיה נפשית, טיפול פסיכולוגי / פסיכיאטרי, אשפוז או תרופות בתחום הנפשי?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"oncology_main", text:"האם קיימת או הייתה מחלת סרטן, גידול, ביופסיה חריגה או מעקב אונקולוגי?", companies:all, fields:[
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"digestive_main", text:"האם קיימת מחלה במערכת העיכול, הכבד, הכליות או דרכי השתן?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"diabetes_main", text:"האם קיימת סוכרת, טרום סוכרת, בלוטת תריס או מחלה הורמונלית / מטבולית?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
              { key:"diagnosisDate", label:"מועד אבחון", type:"text" },
              { key:"treatment", label:"טיפול / אינסולין / ערכים ידועים", type:"textarea" }
            ], requirements:{ default:["שאלון סוכרת / הורמונלי"], "הפניקס":["לעיתים נדרש HbA1c, חלבון בשתן ופגיעה באיברי מטרה"], "מנורה":["בכיסויי חיים לפי סכום וגיל ייתכן תיעוד נוסף"] } },
            { key:"weight_main", text:"האם קיימת השמנת יתר, BMI חריג, ניתוח קיצור קיבה או תת-משקל קיצוני?", companies:["הפניקס","מנורה","איילון","כלל","הראל","מגדל"], fields:[
              { key:"details", label:"פירוט", type:"textarea" },
              { key:"surgeryDate", label:"מועד ניתוח / שינוי משקל", type:"text" }
            ], requirements:{ default:["פירוט מצב משקל / BMI"], "הפניקס":["BMI גבוה עשוי לחייב תמצית מידע / בדיקות דם"], "מנורה":["ניתוח קיצור קיבה מחייב תיעוד לפי מועד הניתוח"] } }
          ]
        },
        {
          ...
          companies: all,
          questions:[
            { key:"blood_main", text:"האם קיימת מחלת דם, הפרעת קרישה, לופוס, מחלה אוטואימונית או HIV / הפטיטיס?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
              { key:"treatment", label:"טיפול", type:"text" },
              { key:"details", label:"סיבוכים / בדיקות / מצב נוכחי", type:"textarea" }
            ], requirements:{ default:["פירוט מלא של אבחנה וטיפול"], "הפניקס":["במחלות דם / לופוס / HIV עשוי להידרש תיעוד רופא"], "הראל":["ייתכן צורך בתוצאות בדיקות עדכניות"] } }
          ]
        },
        {
          key:"musculoskeletal",
          ...
          companies: all,
          questions:[
            { key:"msk_main", text:"האם קיימת בעיה בגב, דיסק, מפרקים, שבר, ניתוח אורתופדי או מחלה ראומטולוגית?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
              { key:"location", label:"מיקום הפגיעה", type:"text" },
              { key:"limitations", label:"מגבלה / כאב / ניתוח / היעדרות מעבודה", type:"textarea" }
            ], requirements:{ default:["שאלון אורטופדי / שלד"], "הפניקס":["לעיתים נדרש פירוט מגבלה תפקודית"], "איילון":["ייתכן צורך בסיכום אורתופד"] } }
          ]
        },
        {
          key:"senses_skin",
          ...
          companies: all,
          questions:[
            { key:"skin_eye_main", text:"האם קיימת מחלת עור, נגעים, פסוריאזיס, בעיית עיניים משמעותית או בעיית אא״ג כרונית?", companies:all, fields:[
              { key:"diagnosis", label:"אבחנה", type:"text" },
              { key:"details", label:"פירוט / ביופסיה / טיפול", type:"textarea" }
        ...
        },
        {
          ...
          companies: all,
          questions:[
            { key:"smoking_main", text:"האם המבוטח מעשן, עישן בעבר, צורך אלכוהול בכמות חריגה או משתמש בסמים / קנאביס?", companies:all, fields:[
            ...
            { key:"family_main", text:"האם קיימת היסטוריה משפחתית מדרגה ראשונה של מחלות לב, סרטן, סוכרת, כליות או מחלות נוירולוגיות?", companies:all, fields:[
        ...
        },
        {
          key:"women",
          title:"נשים / היריון",
          companies:["כלל","הראל","מנורה","הפניקס"],
          questions:[
    ...
    getHealthAge(){
      const ages = (this.insureds || []).map(ins => this.calcAge(ins?.data?.birthDate)).filter(v => Number.isFinite(v));
      return ages.length ? Math.max(...ages) : null;
    },

    getSelectedProductsByCompany(){
      const out = {};
      (this.newPolicies || []).forEach(p => {
        const company = safeTrim(p?.company);
        if(!company) return;
        const type = safeTrim(p?.type);
        const amount = Number(String(p?.sumInsured || p?.compensation || '').replace(/[^\d.]/g,'')) || 0;
        out[company] = out[company] || [];
        out[company].push({ type, amount, raw:p });
      });
      return out;
    },

    normalizeProductForUnderwriting(type){
      const t = safeTrim(type);
      if(!t) return '';
      if(t === 'בריאות') return 'health';
      if(t === 'מחלות קשות' || t === 'סרטן') return 'critical';
      if(t === 'ריסק' || t === 'ריסק משכנתא') return 'life';
      if(t.includes('אכ')) return 'disability';
      return 'other';
    },
    ...
    getUnderwritingRules(){
      return {
        'כלל': {
          life:[
            { minAge:18, maxAge:50, maxAmount:3500000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:18, maxAge:50, maxAmount:5000000, level:'regular', text:'בדיקה רגילה + מעבדה / אק״ג / שתן / HIV / קוטינין' },
            { minAge:18, maxAge:50, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת + ארגומטריה + מעבדה מורחבת' },
            { minAge:51, maxAge:55, maxAmount:2300000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:51, maxAge:55, maxAmount:4000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:51, maxAge:55, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:56, maxAge:60, maxAmount:1500000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:56, maxAge:60, maxAmount:3000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:56, maxAge:60, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:61, maxAge:65, maxAmount:1500000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:61, maxAge:65, maxAmount:2500000, level:'regular', text:'בדיקה רגילה' },
            { minAge:61, maxAge:65, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:66, maxAge:70, maxAmount:1000000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:66, maxAge:70, maxAmount:1200000, level:'regular', text:'בדיקה רגילה' },
            { minAge:66, maxAge:70, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' }
          ]
        },
        'איילון': {
          life:[
            { minAge:0, maxAge:50, maxAmount:3500000, level:'declaration', text:'ללא בדיקה' },
            { minAge:0, maxAge:50, maxAmount:5500000, level:'regular', text:'בדיקה רגילה' },
            { minAge:0, maxAge:50, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:51, maxAge:55, maxAmount:2500001, level:'declaration', text:'ללא בדיקה' },
            { minAge:51, maxAge:55, maxAmount:4000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:51, maxAge:55, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:56, maxAge:60, maxAmount:1500000, level:'declaration', text:'ללא בדיקה' },
            { minAge:56, maxAge:60, maxAmount:3000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:56, maxAge:60, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:61, maxAge:65, maxAmount:1250000, level:'declaration', text:'ללא בדיקה' },
            { minAge:61, maxAge:65, maxAmount:2500000, level:'regular', text:'בדיקה רגילה' },
            { minAge:61, maxAge:65, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:66, maxAge:120, maxAmount:800000, level:'declaration', text:'ללא בדיקה' },
            { minAge:66, maxAge:120, maxAmount:1000001, level:'regular', text:'בדיקה רגילה' },
            { minAge:66, maxAge:120, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' }
          ],
          critical:[
            { minAge:0, maxAge:55, maxAmount:700000, level:'declaration', text:'ללא בדיקה' },
            { minAge:56, maxAge:60, maxAmount:400000, level:'declaration', text:'ללא בדיקה' },
            { minAge:56, maxAge:60, maxAmount:700000, level:'regular', text:'בדיקה רגילה' },
            { minAge:61, maxAge:65, maxAmount:350000, level:'declaration', text:'ללא בדיקה' },
            { minAge:61, maxAge:65, maxAmount:700000, level:'regular', text:'בדיקה רגילה' }
          ]
        },
        'מנורה': {
          life:[
            { minAge:20, maxAge:45, maxAmount:3675000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:20, maxAge:45, maxAmount:6000000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:20, maxAge:45, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:46, maxAge:50, maxAmount:3676000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:46, maxAge:50, maxAmount:6000000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:46, maxAge:50, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:51, maxAge:55, maxAmount:2625000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:51, maxAge:55, maxAmount:5000000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:51, maxAge:55, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:56, maxAge:60, maxAmount:1575000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:56, maxAge:60, maxAmount:3000000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:56, maxAge:60, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:61, maxAge:65, maxAmount:1575000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:61, maxAge:65, maxAmount:3000000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:61, maxAge:65, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:66, maxAge:70, maxAmount:1050000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:66, maxAge:70, maxAmount:1500000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:66, maxAge:70, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:71, maxAge:80, maxAmount:600000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:71, maxAge:80, maxAmount:1000000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:71, maxAge:80, maxAmount:999999999, level:'extended', text:'בדיקה רפואית מורחבת' }
          ],
          health:[
            { minAge:20, maxAge:45, maxAmount:600000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:20, maxAge:45, maxAmount:1000000, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:46, maxAge:50, maxAmount:600000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:46, maxAge:50, maxAmount:1000000, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:51, maxAge:55, maxAmount:300000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:51, maxAge:55, maxAmount:500000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:51, maxAge:55, maxAmount:1000000, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:56, maxAge:65, maxAmount:300000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:56, maxAge:65, maxAmount:400000, level:'regular', text:'בדיקה רפואית רגילה' },
            { minAge:56, maxAge:65, maxAmount:1000000, level:'extended', text:'בדיקה רפואית מורחבת' },
            { minAge:66, maxAge:80, maxAmount:200000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:66, maxAge:80, maxAmount:400000, level:'regular', text:'בדיקה רפואית רגילה' }
          ]
        },
        'הפניקס': {
          life:[
            { minAge:0, maxAge:50, maxAmount:3500000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:0, maxAge:50, maxAmount:6000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:0, maxAge:50, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:51, maxAge:55, maxAmount:2500000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:51, maxAge:55, maxAmount:5000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:51, maxAge:55, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:56, maxAge:60, maxAmount:1500000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:56, maxAge:60, maxAmount:3000000, level:'regular', text:'בדיקה רגילה' },
            { minAge:56, maxAge:60, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת' },
            { minAge:61, maxAge:64, maxAmount:1250000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:61, maxAge:64, maxAmount:2500000, level:'regular', text:'בדיקה רגילה + תמצית מידע מקופ״ח' },
            { minAge:61, maxAge:64, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת + תמצית מידע מקופ״ח' },
            { minAge:65, maxAge:120, maxAmount:800000, level:'declaration', text:'הצהרת בריאות מלאה' },
            { minAge:65, maxAge:120, maxAmount:1000000, level:'regular', text:'בדיקה רגילה + תמצית מידע מקופ״ח' },
            { minAge:65, maxAge:120, maxAmount:999999999, level:'extended', text:'בדיקה מורחבת + תמצית מידע מקופ״ח' }
          ],
          critical:[
            { minAge:0, maxAge:60, maxAmount:600000, level:'declaration', text:'מרפא / מחלות עד 600,000 – הצהרת בריאות' }
          ]
        },
        'הראל': {
          life:[
            { minAge:0, maxAge:50, maxAmount:3500000, level:'declaration', text:'א - הצהרת בריאות מלאה' },
            { minAge:0, maxAge:50, maxAmount:6000000, level:'regular', text:'ב - בדיקה רגילה' },
            { minAge:0, maxAge:50, maxAmount:999999999, level:'extended', text:'ג - בדיקה מורחבת' },
            { minAge:51, maxAge:55, maxAmount:2500000, level:'declaration', text:'א - הצהרת בריאות מלאה' },
            { minAge:51, maxAge:55, maxAmount:5000000, level:'regular', text:'ב - בדיקה רגילה' },
            { minAge:51, maxAge:55, maxAmount:999999999, level:'extended', text:'ג - בדיקה מורחבת' },
            { minAge:56, maxAge:60, maxAmount:1500000, level:'declaration', text:'א - הצהרת בריאות מלאה' },
            { minAge:56, maxAge:60, maxAmount:3000000, level:'regular', text:'ב - בדיקה רגילה' },
            { minAge:56, maxAge:60, maxAmount:999999999, level:'extended', text:'ג - בדיקה מורחבת' }
          ],
          critical:[
            { minAge:0, maxAge:60, maxAmount:300000, level:'declaration', text:'עד 300,000 – חיתום בהתאם לטבלת מחלות קשות' },
            { minAge:61, maxAge:65, maxAmount:350000, level:'regular', text:'מעל תקרה – תיעוד / בדיקה בהתאם לטבלה' }
          ]
        },
        'מגדל': {
          life:[
            { minAge:17, maxAge:50, maxAmount:3500000, level:'declaration', text:'הצהרת בריאות בלבד' },
            { minAge:17, maxAge:50, maxAmount:5000000, level:'regular', text:'הצהרת בריאות + בדיקה / מסמכים' },
            { minAge:17, maxAge:50, maxAmount:999999999, level:'extended', text:'חיתום נוסף / מורחב' },
            { minAge:51, maxAge:55, maxAmount:2500000, level:'declaration', text:'הצהרת בריאות בלבד' },
            { minAge:51, maxAge:55, maxAmount:4000000, level:'regular', text:'הצהרת בריאות + בדיקה / מסמכים' },
            { minAge:51, maxAge:55, maxAmount:999999999, level:'extended', text:'חיתום נוסף / מורחב' },
            { minAge:56, maxAge:60, maxAmount:1500000, level:'declaration', text:'הצהרת בריאות בלבד' },
            { minAge:56, maxAge:60, maxAmount:3000000, level:'regular', text:'הצהרת בריאות + בדיקה / מסמכים' },
            { minAge:56, maxAge:60, maxAmount:999999999, level:'extended', text:'חיתום נוסף / מורחב' },
            { minAge:61, maxAge:67, maxAmount:1100000, level:'declaration', text:'הצהרת בריאות בלבד' },
            { minAge:61, maxAge:67, maxAmount:1500000, level:'regular', text:'הצהרת בריאות + בדיקה / מסמכים' },
            { minAge:61, maxAge:67, maxAmount:999999999, level:'extended', text:'חיתום נוסף / מורחב' }
          ]
        }
      };
    },

    getRuleForProduct(company, normalizedProduct, age, amount){
      const rules = this.getUnderwritingRules()[company]?.[normalizedProduct] || [];
      const a = Number(age || 0);
      const amt = Number(amount || 0);
      return rules.find(r => a >= r.minAge && a <= r.maxAge && amt <= r.maxAmount) || null;
    },

    getUnderwritingDiagnosisRules(){
      return {
        heart_main: {
          default:['שאלון לב'],
          'הפניקס':['תיעוד קרדיולוג / פירוט בדיקות לב שבוצעו'],
          'הראל':['ייתכן צורך בתיעוד רופא / קרדיולוג'],
          'מנורה':['בהתאם לחומרה וסכום – ייתכן תיעוד נוסף']
        },
        resp_main: {
          default:['שאלון ריאות'],
          'הפניקס':['אסתמה / COPD: חומרה, טיפול, סטרואידים, אשפוזים'],
          'איילון':['ייתכנו תפקודי ריאות / סיכום רופא ריאות']
        },
        diabetes_main: {
          default:['שאלון סוכרת / מטבולי'],
          'הפניקס':['ייתכן HbA1c, חלבון בשתן, פגיעה באיברי מטרה'],
          'כלל':['פירוט מלא של טיפול ומצב עדכני'],
          'מנורה':['לפי סכום / גיל עשוי להידרש תיעוד רופא']
        },
        oncology_main: {
          default:['שאלון אונקולוגי'],
          'הפניקס':['10 שנים אחרונות – תיעוד אונקולוג עם מצב עדכני'],
          'הראל':['יש לציין Stage / Grade אם ידוע']
        },
        mental_main: {
          default:['פירוט מלא של אבחנה וטיפול'],
          'הפניקס':['במקרים מסוימים נדרש תיעוד פסיכיאטרי'],
          'הראל':['חומרה / אשפוז / טיפול פסיכיאטרי עשויים לחייב תיעוד']
        },
        weight_main: {
          default:['פירוט BMI / שינויי משקל / ניתוח קיצור קיבה אם קיים'],
          'הפניקס':['BMI גבוה עשוי לחייב תמצית מידע ובדיקות דם'],
          'מנורה':['לאחר ניתוח קיצור קיבה נדרש תיעוד לפי מועד הניתוח']
        }
      };
    },

    getQuestionByKey(qKey){
      for(const cat of this.getHealthSchema()){
        const q = (cat.questions||[]).find(x => x.key === qKey);
        if(q) return { category:cat, question:q };
      }
      return null;
    },

    buildUnderwritingAlerts(){
      const companies = this.getHealthCompanies();
      const age = this.getHealthAge();
      const productsByCompany = this.getSelectedProductsByCompany();
      const store = this.getHealthStore();
      const diagnosisRules = this.getUnderwritingDiagnosisRules();
      const alerts = [];
      companies.forEach(company => {
        const items = productsByCompany[company] || [];
        items.forEach(item => {
          const normalized = this.normalizeProductForUnderwriting(item.type);
          const rule = this.getRuleForProduct(company, normalized, age, item.amount);
          if(rule){
            alerts.push({ company, type:item.type, severity:rule.level, text:rule.text });
          }
        });
      });
      Object.keys(store.categories || {}).forEach(catKey => {
        const catState = store.categories[catKey] || {};
        Object.keys(catState).forEach(qKey => {
          const qState = catState[qKey] || {};
          if(qState.answer !== 'yes') return;
          const reqMap = diagnosisRules[qKey] || {};
          const baseReq = (reqMap.default || []).join(' • ');
          if(baseReq) alerts.push({ company:'כל החברות', type:'רפואי', severity:'warn', text:baseReq, questionKey:qKey });
          companies.forEach(company => {
            const arr = reqMap[company] || [];
            arr.forEach(t => alerts.push({ company, type:'רפואי', severity:'warn', text:t, questionKey:qKey }));
          });
        });
      });
      return alerts;
    ...
    renderUnderwritingAlerts(){
      const alerts = this.buildUnderwritingAlerts();
      if(!alerts.length) return '<div class="lcHAlertEmpty">אין דרישות חיתום מיוחדות כרגע.</div>';
      return alerts.map(a => `<div class="lcHAlertItem ${a.severity || ''}"><strong>${escapeHtml(a.company)}</strong><span>${escapeHtml(a.type ? (a.type + ' · ' + a.text) : a.text)}</span></div>`).join('');
    },

    renderQuestionRequirements(question){
      const companies = this.getHealthCompanies();
      const req = question.requirements || {};
      const rows = [];
      if(Array.isArray(req.default) && req.default.length) rows.push(`<div class="lcHReqRow"><strong>כללי</strong><span>${escapeHtml(req.default.join(' • '))}</span></div>`);
      companies.forEach(c => {
        const items = req[c] || [];
        if(items.length) rows.push(`<div class="lcHReqRow"><strong>${escapeHtml(c)}</strong><span>${escapeHtml(items.join(' • '))}</span></div>`);
      });
      const diagnosis = this.getUnderwritingDiagnosisRules()[question.key] || {};
      companies.forEach(c => {
        const items = diagnosis[c] || [];
        if(items.length) rows.push(`<div class="lcHReqRow"><strong>${escapeHtml(c)}</strong><span>${escapeHtml(items.join(' • '))}</span></div>`);
      });
      return rows.length ? `<div class="lcHReqBox"><div class="lcHReqTitle">מה החברות דורשות</div>${rows.join('')}</div>` : '';
    },
    ...
    renderStep8(){
      ...
      if(!companies.length){
        return `<div class="lcWSection"><div class="lcWTitle">הצהרת בריאות</div><div class="muted">כדי להציג את שלב 8 יש לבחור בשלב 5 לפחות פוליסה של אחת מהחברות הנתמכות.</div></div>`;
      }
      const chips = companies.map(c => `<span class="badge">${escapeHtml(c)}</span>`).join(" ");
      const age = this.getHealthAge();
      const summaryCard = `<div class="lcWSection lcHealthSummaryTop"><div class="row row--between" style="gap:10px;align-items:flex-start;flex-wrap:wrap"><div><div class="lcWTitle">מנוע חיתום חכם</div><div class="muted small" style="margin-top:4px">חברות שנמצאו בשלב 5: ${chips}</div><div class="muted small" style="margin-top:4px">גיל חיתומי מחושב: ${age || 'לא זוהה'}</div></div><div class="lcHInlineAlerts">${this.renderUnderwritingAlerts()}</div></div></div>`;
      const catsHtml = categories.map(cat => {
        ...
        const qs = cat.questions.map(q => {
          ...
          const followup = (qState.answer === "yes") ? `<div class="formGrid" style="padding:14px 0 0">${(q.fields || []).map(f => this.renderHealthField(q.key, f, qState.fields || {})).join("")}</div>${this.renderQuestionRequirements(q)}` : "";
        ...
        return `<div class="lcWSection lcHealthCat">
          ...
          <div class="muted small" style="margin-top:4px">ענה כן / לא. במקרה של כן ייפתח פירוט + דרישות החברות הרלוונטיות.</div>
          <div class="divider"></div>
          <div style="display:grid; gap:14px">${qs}</div>
        </div>`;
      }).join("");
      return `${summaryCard}${catsHtml}`;
    },
