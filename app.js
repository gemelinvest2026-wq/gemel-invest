...
this.applyRoleUI();
  ...
  const SecurityUI = {
    ...
    async render(){
      ...
      if(this.els?.authNote) this.els.authNote.textContent = security.authEmail ? "המשתמש מחובר דרך Supabase Auth עם המייל הזה." : "לפני הפעלת 2FA יש להגדיר למשתמש auth email במסך ניהול משתמשים.";
