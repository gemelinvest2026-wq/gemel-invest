...
(() => {
  ...
  const BUILD = "20260328-clal-risk-pdf-phase2-top-block-align-v2";
...
const ClalRiskWizard = {
    ...
    pdfTextRight(textValue, left, top, cls=''){
      if(!safeTrim(textValue)) return '';
      return `<div class="lcClalRiskPdfText lcClalRiskPdfText--anchorEnd ${cls}" style="left:${left}%; top:${top}%;">${escapeHtml(textValue)}</div>`;
    },
    pdfCheck(checked, left, top, cls=''){
      if(!checked) return '';
      return `<div class="lcClalRiskPdfCheck ${cls}" style="left:${left}%; top:${top}%;">✓</div>`;
    },
    buildPdfMarkup(data){
    ...
    buildPdfPage1(data){
      ...
      return `<div class="lcClalRiskPdfPage">
        ...
        ${this.pdfTextRight(d.insured.lastName, 87.25, 30.75,'lcClalRiskPdfText--topBlock')}
        ${this.pdfTextRight(d.insured.firstName, 75.0, 30.75,'lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.idNumber, 38.55, 30.75,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.birthDate, 27.0, 30.75,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfCheck(genderMale, 16.2, 30.7,'lcClalRiskPdfCheck--tight')}
        ${this.pdfCheck(genderFemale, 11.55, 30.7,'lcClalRiskPdfCheck--tight')}
        ...
        ${this.pdfTextRight(d.insured.street, 62.2, 39.95,'lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.houseNumber, 47.15, 39.95,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfTextRight(d.insured.city, 37.0, 39.95,'lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.zipCode, 28.45, 39.95,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfTextRight(d.insured.occupation, 15.4, 39.95,'lcClalRiskPdfText--topBlock')}
