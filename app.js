...
init(){
    ...
    renderBody(){
      ...
      else if(this.step === 7) body = this.renderHealthDeclStep();
      ...
      if(this.step === 7) this.bindHealthDecl();
    },
...
// ---------- Step 6 ----------
    ...
    validateStep(stepId){
      ...
      // Step 7: health declaration (case-level)
      if(stepId === 7){
        return this.validateStep7();
      }

      // Step 8: summary (no blocking validation yet)
      if(stepId === 8){
        return { ok:true };
      }
