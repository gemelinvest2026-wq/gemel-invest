    ...
    renderReflection(rec){
      ...
      this.els.reflectCard.innerHTML = `<div class="mirrorsCard__head">
          <div>
            ...
            <div class="mirrorsCard__hint">מסך ההקראה הבא לנציג לאחר בחירת אופן קבלת הדיוורים. הפוליסות הקיימות מוצגות כאן כשורות מידע לקריאה בלבד, אחד־אחד.</div>
          </div>
