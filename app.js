...
(() => {
  ...
  const BUILD = "20260324-operational-pdf-real-1";
        ...
        return `<article class="lcReportCoverCard">
          <div class="lcReportCoverCard__top">
            <div>
              ...
              <div class="lcReportCoverCard__sub">${this.renderReportValue(getPolicyInsuredLabelSafe(p))}</div>
            </div>
          ...
          <div class="lcPdfHeader">
            <div class="lcPdfHeader__brand">
              ...
              <div>
                ...
                <div class="lcPdfHeader__sub">מסמך PDF צבעוני לייצוא, שומר את כל נתוני הדוח ללא חיתוך.</div>
              </div>
            </div>
