...
(() => {
  ...
  const BUILD = "20260406-dashboard-kpi-premium-after-discount-v46";
...
// ---------- Step 6 ----------
    ...
    async saveDraft(){
      ...
      if(proposalIssues.length){
        ...
        SaveStatusUI.error('לא ניתן לשמור את ההצעה', firstIssue.message || 'יש נתונים שדורשים תיקון לפני שמירה.');
        return;
      }
    ...
    async finishWizard(){
      ...
      if(premiumIssues.length){
        ...
        this.focusPremiumValidationIssue(firstIssue);
        SaveStatusUI.error('לא ניתן לשמור את הלקוח', firstIssue.message || 'יש נתונים שדורשים תיקון לפני שמירה.');
        return;
      }
