...
(() => {
  ...
  const BUILD = "20260328-elementary-vehicle-wizard-v1";
...
// open health covers drawer (Health only)
    ...
    renderElementaryStep1(ins){
      ...
      const ageText = age === null ? 'הגיל יחושב אוטומטית אחרי הזנת תאריך לידה' : `${age} שנים`;
      return `<div class="lcElementaryWrap">
        <div class="lcElementaryIntro">
          <div class="lcElementaryIntro__title">פרטי מבוטח לרכב</div>
          <div class="lcElementaryIntro__text">מזינים פרטים בסיסיים בלבד. המערכת מחשבת את גיל המבוטח אוטומטית כמו בוויזארד בריאות וסיכונים.</div>
        </div>
        <div class="formGrid lcElementaryFormGrid">
        ...
        <div class="lcElementaryAgeCard">
          <div class="lcElementaryAgeCard__label">גיל המבוטח</div>
          <div class="lcElementaryAgeCard__value">${escapeHtml(ageText)}</div>
          <div class="lcElementaryAgeCard__sub">הגיל נשלף אוטומטית מתאריך הלידה ואינו דורש הקלדה ידנית.</div>
        </div>
      </div>`;
    },
    ...
    renderElementaryVehiclePolicyRows(rows){
      ...
      return `<div class="lcElementaryPolicyList">` + list.map((row) => {
        ...
        return `<div class="lcElementaryPolicyRow">
      ...
      return `<div class="lcElementaryWrap">
        <div class="lcElementaryImportHero">
          <div>
            ...
            <div class="lcElementaryIntro__text">המנוע מסנן רק תחום כללי ורק קטגוריית רכב. פוליסות דירה אינן נמשכות לכאן.</div>
          </div>
