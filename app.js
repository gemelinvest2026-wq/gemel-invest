...
(() => {
  ...
  const BUILD = "20260328-clal-risk-direct-pdf-mapping-v4";
    ...
    renderCurrentStep(){
      ...
      if(this.step === 3){
        ...
        return `<div class="lcClalRiskGrid">
          ...
          <div class="lcClalRiskCard"><div class="lcClalRiskCard__title">מיפוי מוטבים</div><div class="muted">בפעימה הזו החיבור הוא לשורה הראשונה של המוטבים בעמוד 1. בהמשך נוסיף כמה שורות, תאריך לידה ואפשרויות יורשים/צוואה/חברה.</div></div>
        </div>`;
      }
      if(this.step === 4){
        return `<div class="lcClalRiskGrid">
          ...
          <div class="lcClalRiskCard"><div class="lcClalRiskCard__title">חיבור PDF</div><div class="muted">עמוד 1 בטופס יקבל את פרטי המבוטח, שאלות הסיכון, המוטב הראשי ותאריך תחילת הביטוח. הפעימה הנוכחית מוסיפה גם מיפוי כיסויים לעמוד 2.</div></div>
        </div>`;
      }
      const checks = [
      ...
      return `<div class="lcClalRiskSummary">
        ...
        <div class="lcClalRiskCard"><div class="lcClalRiskCard__title">סיכום פאזה 2</div><div class="lcClalRiskSummary">
          ...
          <div class="lcClalRiskSummaryRow"><b>יצוא</b><span>לחץ על “הורד PDF” כדי להפיק PDF ראשוני לעמודים 1-3 של כלל ריסק.</span></div>
        </div></div>
      </div>`;
    },
  ...
  async exportPdf(){
    try{
      ...
      try{
        ...
        pdf.save(fileName);
        this.els.meta.textContent = 'PDF כלל ריסק נוצר במיפוי ישיר על גבי הטופס.';
      ...
      window.alert('לא הצלחתי להפיק את ה-PDF של כלל ריסק. בדוק שהתמונות של הטופס קיימות בריפו ונסה שוב.');
    }
  }
};
