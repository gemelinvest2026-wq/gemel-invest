    ...
    render(){
      ...
      UI.els.customersTbody.innerHTML = rows.length ? rows.map(rec => {
        return `<tr class="lcCustomerRow">
          ...
          <td><div class="lcCustomers__agentCell"><span class="lcCustomers__agentLabel">נציג</span><span class="lcCustomers__agentName">${escapeHtml(rec.agentName || "—")}</span></div></td>
          <td>
