    ...
    render(){
      ...
      UI.els.customersTbody.innerHTML = rows.length ? rows.map(rec => {
        ...
        return `<tr class="lcCustomerRow">
          ...
          <td><div class="lcCustomers__agentCell"><span class="lcCustomers__agentLabel">נציג</span><strong class="lcCustomers__agentName">${escapeHtml(rec.agentName || "—")}</strong></div></td>
      ...
      }).join("") : `<tr><td colspan="6"><div class="emptyState"><div class="emptyState__icon">🗂️</div><div class="emptyState__title">עדיין אין לקוחות</div><div class="emptyState__text">ברגע שמסיימים הקמת לקוח, הלקוח יישמר כאן אוטומטית ויהיה אפשר לפתוח את תיק הלקוח המלא.</div></div></td></tr>`;
