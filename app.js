...
const ClalRiskWizard = {
    ...
    buildPdfPage1(data){
      ...
      return `<div class="lcClalRiskPdfPage">
        ...
        ${this.pdfTextRight(d.insured.lastName, 87.8, 30.25,'lcClalRiskPdfText--topBlock')}
        ${this.pdfTextRight(d.insured.firstName, 75.5, 30.25,'lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.idNumber, 39.1, 30.35,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.birthDate, 27.5, 30.35,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfCheck(genderMale, 16.75, 30.35,'lcClalRiskPdfCheck--tight')}
        ${this.pdfCheck(genderFemale, 12.05, 30.35,'lcClalRiskPdfCheck--tight')}
        ...
        ${this.pdfTextRight(d.insured.street, 62.8, 39.55,'lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.houseNumber, 47.7, 39.55,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfTextRight(d.insured.city, 37.5, 39.55,'lcClalRiskPdfText--topBlock')}
        ${this.pdfText(d.insured.zipCode, 29.0, 39.55,'lcClalRiskPdfText--ltr lcClalRiskPdfText--topBlock')}
        ${this.pdfTextRight(d.insured.occupation, 16.0, 39.55,'lcClalRiskPdfText--topBlock')}
