    ...
    renderElementaryStep1(ins){
      ...
      return `<div class="lcElementaryWrap">
        <div class="formGrid lcElementaryFormGrid lcElementaryFormGrid--clean">
          ...
          <div class="lcElementaryBirthDateFieldWrap">
            ${this.fieldDate('תאריך לידה','birthDate', d.birthDate, { nativePicker:true, className:'lcElementaryDateInput', max: this.getTodayIsoDate() })}
            <div class="lcElementaryAgeInline ${hasAge ? 'is-visible is-animate' : ''}" data-elementary-age-inline>
              ...
              <span class="lcElementaryAgeInline__value" data-elementary-age-value>${escapeHtml(ageText)}</span>
            </div>
          </div>
        </div>
      </div>`;
