          ...
          <div class="lcPolBuilderCard">
            ...
            <div class="lcPolSmartRow">
              ...
              <div class="lcField lcPolField lcPolField--premiumMain">
                ...
                <div class="lcPolMoneyWrap">
                  <span class="lcPolMoneyWrap__symbol">₪</span>
              ...
              <div class="lcField lcPolField lcPolField--submit">
                <label class="lcLabel lcLabel--ghost">הוספה</label>
                <button type="button" class="lcBtn lcBtn--primary lcPolAddBtn" data-addpol="1">${this.editingPolicyId ? "שמור שינויים" : "הוסף פוליסה"}</button>
              </div>
            </div>

            ${(needSum || needComp || canPledge) ? `<div class="lcPolSmartRow lcPolSmartRow--secondary">
