...
/* ===== Internal Mail: Toast + Sound on new incoming mail (SCOPED) ===== */
(function(){
  const PING_SRC = "data:audio/wav;base64,";
  let mailPing = null;
  try{ mailPing = new Audio(PING_SRC); mailPing.volume = 0.55; }catch(_){}

  function ensureMailCapsuleState(){
    try{
      const btn = document.getElementById('mailBtn');
      if(!btn) return;
      btn.classList.add('mailCapsule');
      const n = (typeof unreadCount_ === 'function') ? unreadCount_() : 0;
      if(n > 0) btn.classList.add('hasUnread'); else btn.classList.remove('hasUnread');
    }catch(_){}
  }
  ...
  function showMailToast(fromName, onOpen){
    ...
    const el = document.createElement('div');
    el.className = 'mailToast';
    const safe = (typeof escapeHtml === 'function') ? escapeHtml(String(fromName || 'נציג')) : String(fromName || 'נציג');
    el.innerHTML =
      '<div class="mailToastFrom">מאת: ' + safe + '</div>' +
      '<div class="mailToastActions">' +
        '<button type="button" class="mailToastBtn" data-dismiss>דחה</button>' +
        '<button type="button" class="mailToastBtn primary" data-open>פתח</button>' +
      '</div>';
    wrap.appendChild(el);

    try{ if(mailPing) mailPing.play(); }catch(_){}

    const kill = () => { try{ el.remove(); }catch(_){} };
    el.querySelector('[data-dismiss]')?.addEventListener('click', kill);
    el.querySelector('[data-open]')?.addEventListener('click', () => {
      kill();
      try{ if(typeof onOpen === 'function') onOpen(); }catch(_){}
    });
  ...
  function snapshotInboxIds(){
    try{
      if(typeof inboxMessages_ !== 'function') return [];
      const list = inboxMessages_();
      return (Array.isArray(list) ? list : []).map(m => m && m.id).filter(Boolean);
    }catch(_){ return []; }
  }

  function checkNewMail(){
    try{
      if(!window.state || !state.currentUser){ ensureMailCapsuleState(); return; }
      const ids = snapshotInboxIds();

      if(!initialized){
        ids.forEach(id => lastSeenIds.add(id));
        initialized = true;
        ensureMailCapsuleState();
        return;
      }

      const newOnes = [];
      ids.forEach(id => { if(!lastSeenIds.has(id)) newOnes.push(id); });
      ...
      if(newOnes.length){
        ...
        try{
          ...
          newOnes.forEach(id => {
            ...
            if(!m) return;
            if(!newest || (m.createdAt||0) > (newest.createdAt||0)) newest = m;
          });
        }catch(_){}
        newOnes.forEach(id => lastSeenIds.add(id));

        const fromName = newest ? (newest.fromName || newest.fromUser || 'נציג') : 'נציג';
        showMailToast(fromName, () => { try{ openMail_(); }catch(_){} });
      }

      ensureMailCapsuleState();
    }catch(_){ ensureMailCapsuleState(); }
  }

  window.addEventListener('storage', (e) => {
    try{ if(e && e.key === 'gemel_messages_v1') checkNewMail(); }catch(_){}
  });
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
      ...
      lastSeenIds = new Set();
      checkNewMail();
      setInterval(checkNewMail, 2500);
    }, 900);

    document.addEventListener('click', () => {
      try{
        if(mailPing){
          mailPing.play().then(()=>{ mailPing.pause(); mailPing.currentTime = 0; }).catch(()=>{});
        }
      }catch(_){}
    }, { once:true });
  });
